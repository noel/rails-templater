  ...
  module Generators
    module Actions
      ...
      def load_options
        ...
        @template_options[:design] = "compass" if @template_options[:design].blank?
        puts "DESGIN option is ->  #{@template_options[:design]}"
        ...
        puts "cuke option is ->  #{@template_options[:cucomber]}"
